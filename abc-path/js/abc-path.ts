...
ABC_Path.Solver.Move.LastRemainingLetterForCell = class extends ABC_Path.Solver
    .Move {};
ABC_Path.Solver.Move.LettersNotInVicinity = class extends ABC_Path.Solver
    .Move {};
ABC_Path.Solver.Move.TryingLetterForCell = class extends ABC_Path.Solver
    .Move {};
ABC_Path.Solver.Move.ResultsInAnError = class extends ABC_Path.Solver.Move {};
ABC_Path.Solver.Move.ResultsInASuccess = class extends ABC_Path.Solver.Move {};
ABC_Path.Solver.Board = class extends ABC_Path.Solver.Base {
    constructor() {
        super();
        this.letters_map = (() => {
            var ret = {};
