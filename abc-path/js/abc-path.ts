        ...
        class Generator extends Base {
            ...
            constructor(r) {
                ...
                this._get_next_cells_lookup = (() => {
                    var that = this;
                    return this._perl_range(0, this.BOARD_SIZE() - 1).map(
                        function(cell) {
            ...
            _get_next_cells(l, init_idx) {
                return this._get_next_cells_lookup[init_idx].filter(function(
                    x,
                ) {
            ...
            _add_next_state(stack, orig_l, cell_int) {
                ...
                stack.push([
                    l,
                    this._shuffle(this._get_next_cells(l, cell_int)),
                ]);
                ...
                DFS: while (dfs_stack.length > 0) {
                    ...
                    if (last_state.chosen_clue < 0) {
                        ...
                        if (clues.length == 0) {
                            ...
                            if (
                                solver.get_successes_text_tables().length != 1
                            ) {
