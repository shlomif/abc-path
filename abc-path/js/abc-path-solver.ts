import { ResultsInAnError, ResultsInASuccess, LastRemainingLetterForCell, TryingLetterForCell, LastRemainingCellForLetter , LettersNotInVicinity } from './abc-path-move';
                ...
                board._l_indexes().forEach(function(letter) {
                    ...
                    neighbour_letters.forEach(function(neighbour_letter) {
                        board._xy_loop(function(x, y) {
                            ...
                            if (
                                existing_verdict == board.ABCP_VERDICT_MAYBE()
                            ) {
                                board._set_verdict(
                                    neighbour_letter,
                                    x,
